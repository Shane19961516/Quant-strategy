...
from .strategies_12 import BookConfig, run_s1
from .strategies_3 import run_s3
from .strategies_4 import load_cached_contracts_only, load_or_fetch_contracts, run_s4
...
def run_defined_book(
    ...
    sum_total["max_margin"] = (
        sum_total["max_margin_s1"] + sum_total["max_margin_s3"] + sum_total["max_margin_s4"]
    )
