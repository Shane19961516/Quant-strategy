# 下一交易日候选 · Short Strangle · 数据截止 2026-08-20T09:11:43
...
- `quote_asof`: 2026-08-20T09:11:43
- `target_session`: 2026-08-21
- `model`: Black-76 (American risk flagged)
- `account_equity`: None
- 扫描品种: 13 · 推荐: 0 · 观察: 13 · 排除: 0

## 1. 分类摘要

**今日无推荐**（全部硬闸门未同时满足或缺少客户保证金/账户权益/252日IV历史）。

### 观察池

- **豆粕** m2611 — 权/保比(无优惠) 7.9% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **菜油** OI2611 — IVR/IVP 未达标 (IVR=46.351552853514264, IVP=32.6797385620915); 数据闸门未全部通过: client_margin_known; iv_history_252
- **白糖** SR2611 — IVR/IVP 未达标 (IVR=29.213075764588602, IVP=28.205128205128204); 权/保比(无优惠) 6.4% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **棉花** CF2611 — IVR/IVP 未达标 (IVR=41.430682145575545, IVP=12.903225806451612); 权/保比(无优惠) 6.0% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **黄金** au2610 — IVR/IVP 未达标 (IVR=8.618625127602122, IVP=27.31958762886598); 单腿持仓量不足 Call=428.0 Put=389.0; 数据闸门未全部通过: client_margin_known; iv_history_252
- **橡胶** ru2610 — IVR/IVP 未达标 (IVR=15.422980940304607, IVP=15.976331360946746); 单腿持仓量不足 Call=29.0 Put=46.0; 权/保比(无优惠) 3.8% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **玉米** c2611 — 权/保比(无优惠) 4.1% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **菜粕** RM2611 — 数据闸门未全部通过: client_margin_known; iv_history_252
- **沪铜** cu2610 — IVR/IVP 未达标 (IVR=9.341169544935966, IVP=5.617977528089887); 权/保比(无优惠) 4.6% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **铁矿石** i2610 — IVR/IVP 未达标 (IVR=58.3205996643914, IVP=66.47398843930635); 权/保比(无优惠) 5.0% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **PTA** TA2610 — IVR/IVP 未达标 (IVR=30.63424466571312, IVP=36.024844720496894); VRP≤0 (-0.066); 权/保比(无优惠) 7.8% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- **甲醇** MA2610 — VRP≤0 (-0.087); 数据闸门未全部通过: client_margin_known; iv_history_252
- **LPG** pg2610 — VRP≤0 (-0.116); 单腿持仓量不足 Call=274.0 Put=154.0; 数据闸门未全部通过: client_margin_known; iv_history_252

## 2. 候选明细

| 分类 | 品种 | 标的期货 | 月份/DTE | 卖C/K/买一 | 卖P/K/买一 | σ* | IVR | IVP | VRP | 技分 | 权/保(无优惠) | RN-POP | 建议手数 |
|---|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|
| 观察 | 豆粕 | m2611 | m2611/68d | 3500.0/25.0 | 3100.0/14.0 | 22.0% | 96.0 | 93.6 | 7.9% | 42 | 7.9% | 68.0% | N/A(缺权益) |
| 观察 | 菜油 | OI2611 | oi2611/68d | 11600.0/68.5 | 10000.0/71.5 | 23.9% | 46.4 | 32.7 | 7.8% | 39 | 9.5% | 70.4% | N/A(缺权益) |
| 观察 | 白糖 | SR2611 | sr2611/68d | 5500.0/32.0 | 5000.0/15.0 | 15.9% | 29.2 | 28.2 | 7.4% | 52 | 6.4% | 79.4% | N/A(缺权益) |
| 观察 | 棉花 | CF2611 | cf2611/68d | 17600.0/77.0 | 16000.0/65.0 | 18.0% | 41.4 | 12.9 | 7.2% | 55 | 6.0% | 69.1% | N/A(缺权益) |
...
| 观察 | 玉米 | c2611 | c2611/68d | 2360.0/7.0 | 2180.0/8.5 | 13.4% | 100.0 | 98.7 | 4.5% | 49 | 4.1% | 69.4% | N/A(缺权益) |
| 观察 | 菜粕 | RM2611 | rm2611/68d | 2450.0/14.5 | 2175.0/14.0 | 22.4% | 94.4 | 94.2 | 1.6% | 63 | 8.2% | 48.5% | N/A(缺权益) |
| 观察 | 沪铜 | cu2610 | cu2610/36d | 112000.0/480.0 | 102000.0/308.0 | 13.7% | 9.3 | 5.6 | 1.4% | 66 | 4.6% | 77.5% | N/A(缺权益) |
| 观察 | 铁矿石 | i2610 | i2610/36d | 750.0/3.6 | 690.0/3.9 | 16.1% | 58.3 | 66.5 | 0.2% | 66 | 5.0% | 59.1% | N/A(缺权益) |
| 观察 | PTA | TA2610 | ta2610/36d | 6300.0/38.5 | 5500.0/26.5 | 22.9% | 30.6 | 36.0 | -6.6% | 70 | 7.8% | 53.3% | N/A(缺权益) |
| 观察 | 甲醇 | MA2610 | ma2610/36d | 3100.0/19.0 | 2650.0/21.5 | 26.4% | 62.0 | 61.3 | -8.7% | 48 | 10.6% | 51.7% | N/A(缺权益) |
| 观察 | LPG | pg2610 | pg2610/36d | 6200.0/41.2 | 5250.0/39.8 | 29.0% | 60.5 | 72.7 | -11.6% | 53 | 8.4% | 48.1% | N/A(缺权益) |
...
- 保证金: 单腿C=2,412 P=2,532 · 无优惠=4,944 · 理论组合=2,782 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 156 日，需要 252 日)
- 分类理由: 权/保比(无优惠) 7.9% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=6,615 P=8,095 · 无优惠=14,710 · 理论组合=8,780 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 153 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=46.351552853514264, IVP=32.6797385620915); 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=3,512 P=3,822 · 无优惠=7,334 · 理论组合=4,142 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 156 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=29.213075764588602, IVP=28.205128205128204); 权/保比(无优惠) 6.4% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=5,709 P=6,049 · 无优惠=11,758 · 理论组合=6,434 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 155 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=41.430682145575545, IVP=12.903225806451612); 权/保比(无优惠) 6.0% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=46,085 P=54,680 · 无优惠=100,764 · 理论组合=61,980 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 194 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=8.618625127602122, IVP=27.31958762886598); 单腿持仓量不足 Call=428.0 Put=389.0; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=16,344 P=14,114 · 无优惠=30,458 · 理论组合=16,654 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 169 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=15.422980940304607, IVP=15.976331360946746); 单腿持仓量不足 Call=29.0 Put=46.0; 权/保比(无优惠) 3.8% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=1,836 P=1,941 · 无优惠=3,777 · 理论组合=2,011 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 156 日，需要 252 日)
- 分类理由: 权/保比(无优惠) 4.1% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=1,557 P=1,907 · 无优惠=3,464 · 理论组合=2,052 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 156 日，需要 252 日)
- 分类理由: 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=42,980 P=42,820 · 无优惠=85,800 · 理论组合=45,380 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 178 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=9.341169544935966, IVP=5.617977528089887); 权/保比(无优惠) 4.6% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=7,221 P=7,701 · 无优惠=14,922 · 理论组合=8,061 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 173 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=58.3205996643914, IVP=66.47398843930635); 权/保比(无优惠) 5.0% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=1,986 P=2,186 · 无优惠=4,173 · 理论组合=2,379 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 161 日，需要 252 日)
- 分类理由: IVR/IVP 未达标 (IVR=30.63424466571312, IVP=36.024844720496894); VRP≤0 (-0.066); 权/保比(无优惠) 7.8% < 8%; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=1,664 P=2,149 · 无优惠=3,813 · 理论组合=2,339 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 173 日，需要 252 日)
- 分类理由: VRP≤0 (-0.087); 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
...
- 保证金: 单腿C=8,934 P=10,326 · 无优惠=19,259 · 理论组合=11,150 (unclear) · 客户预计=N/A
...
- 未过闸门: client_margin_known(未提供客户/期货公司保证金加收比例); account_equity(未提供账户权益，不建议手数); iv_history_252(固定期限 ATM IV 历史仅 165 日，需要 252 日)
- 分类理由: VRP≤0 (-0.116); 单腿持仓量不足 Call=274.0 Put=154.0; 数据闸门未全部通过: client_margin_known; iv_history_252
- 事件: 事件过滤已关闭
